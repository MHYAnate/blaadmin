...
import IndividualStatsCard from "./individual-stats-card"
  ...
  return (
    <div className="space-y-6 mb-10">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Comprehensive overview of your customer base segmented by type</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <IndividualStatsCard
          individualUsers={customerStats.individualUsers}
          totalCustomers={customerStats.totalCustomers}
          individualPercentage={customerStats.individualPercentage}
        />
      </div>
    </div>
  )
